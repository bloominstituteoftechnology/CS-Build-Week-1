...
class Life {
  ...
  step() {
    ...
    function switches(condition) {
      let cases = {
        0 : function() {
          return;
        },
        1 : function() {
          return colorCount.red++;
        },
        2 : function() {
          return colorCount.green++;
        },
        3: function() {
          return colorCount.blue++;
        }
      };
      ...
      // West
      if(col > 0){
        switches(currentBuffer[row][col - 1]);
      }
      ...
      // Northwest
      if(col > 0 && row > 0){
        switches(currentBuffer[row - 1][col - 1]);
      }
      ...
      // North
      if(row > 0){
        switches(currentBuffer[row - 1][col]);
      }
