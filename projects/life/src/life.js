/**
 * Implementation of Conway's game of Life    <sp :)
 */
    ...
    step() {
        ...
        for (let y = 0; y < this.height; y++) {
            for (let x = 0; x < this.width; x++) {
                ...
                if (thisCell === 1) {
                    if (neighborCount < 2 || neighborCount > 3) {              //too crowded ded.
                        backBuffer[y][x] = 0;
                    } else {
                        backBuffer[y][x] = 1;                                //perf
                    }
                } else {
                    if (neighborCount === 3) {             //wakeup
                        backBuffer[y][x] = 1;
                    } else {
                        backBuffer[y][x] = 0;                    //dedded
                    }
                }
            }
        }
